...
public class Book {
	...
	private int forTakingHome; // если 0 - можно брать домой, если 1 - для чтения в читальном зале
	private int quantityOfThisBooks;

	public Book(String name, String author, String genre, boolean isSoftCover, int yearOfPublishing, int forTakingHome,
			int quantityOfThisBooks) {
		this.name = name;
		this.author = author;
		this.genre = genre;
